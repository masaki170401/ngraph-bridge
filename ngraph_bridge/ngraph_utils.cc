...
const gtl::ArraySlice<DataType>& NGraphIndexDTypes() {
  static DataType dtlst[] = {DT_INT32, DT_INT64};
  static gtl::ArraySlice<DataType> result(dtlst);
  return result;
}

const gtl::ArraySlice<DataType>& NGraphSupportedQuantizedDTypes() {
  static DataType dtlst[] = {DT_QINT8, DT_QUINT8};
  static gtl::ArraySlice<DataType> result(dtlst);
  return result;
}

const gtl::ArraySlice<DataType>& NGraphRealDTypes() {
  static DataType dtlst[] = {DT_FLOAT, DT_DOUBLE};
  static gtl::ArraySlice<DataType> result(dtlst);
  return result;
}

const gtl::ArraySlice<DataType>& NGraphBiasDTypes() {
  static DataType dtlst[] = {DT_FLOAT, DT_QINT32};
  static gtl::ArraySlice<DataType> result(dtlst);
  return result;
}
